...
<div class="nav dsc-zoom" ectype="dscNav">
	...
	<div class="crumbs-nav-main clearfix">
			...
			<i class="iconfont icon-right"></i>		</div>
						<span class="cn-goodsName">AUX/奥克斯 3匹除湿大功率广角送风空调立柜机 KFR-72LW/NSP1+3 自动升降面板 商居两用</span>
			</div>
</div>
        </div>
    </div>
	...
	<div class="gallery_wrap">
        <ul>
                        <li ectype="img">
                <a href="images/201703/goods_img/0_P_1490175614509.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: img-hover; selectors-change: mouseover; zoom-distance: 10;zoom-width: 400; zoom-height: 474;">
                    <img src="images/201703/goods_img/0_P_1490175614509.jpg" id="J_prodImg" alt="AUX/奥克斯 3匹除湿大功率广角送风空调立柜机 KFR-72LW/NSP1+3 自动升降面板 商居两用">
                </a>
            </li>
        </ul>
    </div>
	<div class="spec-list">
		...
		<div class="spec-items">
			<ul>
                                ...
                                <li data-type="img">
					<a href="images/201703/goods_img/0_P_1490175614509.jpg" rel="zoom-id: Zoomer" rev="images/201703/goods_img/0_P_1490175614509.jpg" class="img-hover">
						<img src="images/201703/thumb_img/0_thumb_P_1490175614076.jpg" alt="AUX/奥克斯 3匹除湿大功率广角送风空调立柜机 KFR-72LW/NSP1+3 自动升降面板 商居两用" width="58" height="58" />
					</a>
				</li>
        ...
        <div class="short-share-r bar_code hide">条形条码：<em id="bar_code"></em></div>        <div class="left-btn">
            <div class="duibi">
                <a href="javascript:void(0);" id="compareLink">
                    <input type="checkbox" name="" class="ui-checkbox" id="811" onClick="Compare.add(this, 811,'AUX/奥克斯 3匹除湿大功率广角送风空调立柜机 KFR-72LW/NSP1+3 自动升降面板 商居两用','0', 'images/201703/thumb_img/0_thumb_G_1490175614721.jpg', '4199', '<em>¥</em>5038.80')">
                    <label for="811" class="ui-label">对比</label>
                </a>
            </div>
            <a href="javascript:void(0);" class="collection choose-btn-coll" data-dialog="goods_collect_dialog" data-divid="goods_collect" data-url="user.php?act=collect" data-goodsid="811" data-type="goods"><i class="iconfont choose-btn-icon icon-collection" id="collection_iconfont"></i><em>收藏 (<span id="collect_count"></span>)</em></a>
...
function get_collection(){
	Ajax.call('ajax_dialog.php', 'act=goods_collection&goods_id=' + 811, goodsCollectionResponse, 'GET', 'JSON');
}
function goodsCollectionResponse(res){
	...
	if(res.is_collect > 0){
		...
		$("#collection_iconfont").removeClass('icon-collection-alt');
                    ...
                    <form action="javascript:addToCart(811)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
                		<div class="name">AUX/奥克斯 3匹除湿大功率广角送风空调立柜机 KFR-72LW/NSP1+3 自动升降面板 商居两用</div>
                                                                        <div class="summary">
                                ...
                                <div class="s-p-w-wrap">
                                    <div class="summary-item si-shop-price">
                                        ...
                                        <div class="si-warp">
                                            ...
                                            <span class="price-notify" data-userid="0" data-goodsid="811" ectype="priceNotify">降价通知</span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="qrcode-wrap">
                                            ...
                                            <div class="qrcode_pop">
                                                <div class="mobile-qrcode"><img src="images/weixin_img/weixin_code_811.png" alt="商品二维码" title="" width="175"></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="si-warp">
                                                                                        <a class="J-open-tb" href="#none" data-goodsid="811">
                            ...
                            <div class="choose-btns ml60 clearfix">
                                                                                                                                                                                                        <a href="javascript:bool=0;addToCart(811)" data-type="0" class="btn-buynow" ectype="btn-buynow">立即购买</a>
                                                                                                    <a href="javascript:bool=0;addToCartShowDiv(811)" class="btn-append" ectype="btn-append"><i class="iconfont icon-carts"></i>加入购物车</a>
                        ...
                        <input type="hidden" value="811" name="goods_id" />
                        <input type="hidden" value="811" id="good_id" name="good_id" />
	...
	<div class="mt">
		<h3>文旅自营</h3>
					<a id="IM" onclick="openWin(this)" href="javascript:;" ru_id="0" goods_id="811" class="s-a-kefu"><i class="icon i-kefu"></i></a>
			</div>
	<div class="mc">
		<div class="mc-warp">
			<div class="g-s-brand">
                                	...
                                	<div class="tb-popsku">
                                        ...
                                        <div class="tb-popsku-content">
                                            ...
                                            <div class="tb-list">
                                                ...
                                                <div class="tb-value">
													<a href="javascript:bool=0;addToCartShowDiv(811)" class="cz-btn cz-btn-true" ectype="btn-append">确定</a>
                    ...
                    <div class="gm-floors" ectype="gm-floors">
                        <div class="gm-f-item gm-f-details" ectype="gm-item">
                            ...
                            <div class="goods-para-list">
                                <dl class="goods-para">
                                    <dd class="column"><span>商品名称：AUX/奥克斯 3匹除湿大功率广角送风空调立柜机 KFR-72LW/NSP1+3 自动升降面板 商居两用</span></dd>
                                    <dd class="column"><span>商品编号：ECS000811</span></dd>
                                    <dd class="column"><span>店铺：<a href="" title="文旅自营" target="_blank">文旅自营</a></span></dd>
                                                                        <dd class="column"><span>重量：0克</span></dd>
                                                                                                            <dd class="column"><span>上架时间：2017-03-23 01:40:17</span></dd>
                                                                    </dl>
                                                                                                                            </div>
                            <p>
...
<p>
    <img src="http://demo.zz.jabrielcloud.com/data/gallery_album/3/original_img/1585442855076760435.png"/>
                            ...
                            <div class="gm-title">
                                <h3>评论晒单</h3>
                                554fcae493e564ee0dc75bdf2ebf94cagoods_comment_title|a:2:{s:4:"name";s:19:"goods_comment_title";s:8:"goods_id";s:3:"811";}554fcae493e564ee0dc75bdf2ebf94ca                            </div>
                            <div class="gm-warp">
                                ...
                                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:811;}554fcae493e564ee0dc75bdf2ebf94ca</div>                                </div>
                            </div>
                        </div>
                        <div class="gm-f-item gm-f-tiezi" ectype="gm-item">
                            554fcae493e564ee0dc75bdf2ebf94cagoods_discuss_title|a:2:{s:4:"name";s:19:"goods_discuss_title";s:8:"goods_id";s:3:"811";}554fcae493e564ee0dc75bdf2ebf94ca                            <div class="table" id='discuss_list_ECS_COMMENT'></div>
                        </div>
                    </div>
                </div>
                <div class="clear"></div>
...
<script type="text/javascript" src="js/warehouse.js"></script><script type="text/javascript" src="js/warehouse_area.js"></script>
			...
			if(res.err_no == 2){
				...
				if($("#isHas_warehouse_num").length > 0){
					if((res.attr_number > 0) && (res.attr_number > 0 || res.original_spec_price == res.original_shop_price) && (1 != 0 || is_shipping == 1)){
						$("a[ectype='btn-append']").attr('href','javascript:addToCartShowDiv(811)').removeClass('btn_disabled');
						$("a[ectype='btn-buynow']").attr('href','javascript:addToCart(811)').removeClass('btn_disabled');
						...
						$("a[ectype='byStages']").addClass('btn_disabled');
								...
								if(1 != 0 || is_shipping == 1){
									...
									$('.choose-btns').append('<a id="quehuo" class="btn-buynow" href="javascript:addToCart(811);">暂时缺货</a>');
								}
							}
											}
					if(res.store_type == 1){
    ...
    554fcae493e564ee0dc75bdf2ebf94cagoods_delivery_area_js|a:2:{s:4:"name";s:22:"goods_delivery_area_js";s:4:"area";a:11:{s:9:"region_id";s:1:"1";s:11:"province_id";s:1:"2";s:7:"city_id";s:2:"52";s:11:"district_id";s:3:"500";s:9:"street_id";s:1:"0";s:11:"street_list";s:1:"0";s:8:"goods_id";i:811;s:7:"user_id";i:0;s:7:"area_id";s:1:"4";s:9:"area_city";s:3:"403";s:11:"merchant_id";s:1:"0";}}554fcae493e564ee0dc75bdf2ebf94ca</body>
</html>