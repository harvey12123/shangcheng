<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:55:"D:/wamp64/www/zz/themes/ecmoban_dsc2017/article_cat.dwt";i:1;s:68:"D:/wamp64/www/zz/themes/ecmoban_dsc2017/library/js_languages_new.lbi";i:2;s:70:"D:/wamp64/www/zz/themes/ecmoban_dsc2017/library/page_header_common.lbi";i:3;s:57:"D:/wamp64/www/zz/themes/ecmoban_dsc2017/library/pages.lbi";i:4;s:63:"D:/wamp64/www/zz/themes/ecmoban_dsc2017/library/page_footer.lbi";}s:7:"expires";i:1589860388;s:8:"maketime";i:1589856788;}<!doctype html>
<html>
<head>
    ...
    <div class="w w1200 clearfix">
        <div class="article-side">
            <dl class="article-menu">
                ...
                <dd class="am-c">
                                        <div class="menu-item active">
                        <div class="item-hd"><a href="article_cat.php?id=19">发票问题</a><i class="iconfont icon-up"></i></div>
                                            </div>
                                        <div class="menu-item active">
                        <div class="item-hd"><a href="article_cat.php?id=12">站内快讯</a><i class="iconfont icon-up"></i></div>
                                            </div>
                                        <div class="menu-item active">
                        <div class="item-hd"><a href="article_cat.php?id=13">商城公告</a><i class="iconfont icon-up"></i></div>
                                            </div>
                                        <div class="menu-item active">
                        <div class="item-hd"><a href="javascript:void(0)">App</a><i class="iconfont icon-up"></i></div>
                                        ...
                                        <div class="menu-item active">
                        <div class="item-hd"><a href="article_cat.php?id=20">公告</a><i class="iconfont icon-up"></i></div>
                                            </div>
                                        <div class="menu-item active">
                        <div class="item-hd"><a href="article_cat.php?id=21">促销</a><i class="iconfont icon-up"></i></div>
                                            </div>
                                    </dd>
            </dl>
                    </div>
        <div class="article-main">
            ...
            <div class="am-bd">
                <ul class="artilce-list">
                                        <li>
                        <h3><a href="article.php?id=56" title="发票中是否显示运费金额？">发票中是否显示运费金额？</a></h3>
                        <p></p>
                    </li>
                                    </ul>
            </div>
