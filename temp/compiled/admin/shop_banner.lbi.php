                ...
                <div class="table_list" ectype='pic_list'>
                    <div class="gallery_album" data-act="get_albun_pic" data-inid="pic_list" data-url='get_ajax_content.php' data-where="sort_name=<?php echo $this->_var['filter']['sort_name']; ?>&album_id=<?php echo $this->_var['filter']['album_id']; ?>">
                        <ul class="ga-images-ul">
                            <?php $_from = $this->_var['pic_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'pic_list_0_93541200_1590396117');if (count($_from)):
    foreach ($_from AS $this->_var['pic_list_0_93541200_1590396117']):
?>
                            <li><a href="javascript:;" onclick="addpic('<?php echo $this->_var['pic_list_0_93541200_1590396117']['pic_file']; ?>',this)"><img src="<?php echo $this->_var['pic_list_0_93541200_1590396117']['pic_file']; ?>"><span class="pixel"><?php echo $this->_var['pic_list_0_93541200_1590396117']['pic_spec']; ?></span></a></li>
                            <?php endforeach; else: ?>
...
?>
                    ...
                    <div class="table_list" ectype='pic_list'>
                        <div class="gallery_album" data-act="get_albun_pic" data-inid="pic_list" data-url='get_ajax_content.php' data-where="sort_name=<?php echo $this->_var['filter']['sort_name']; ?>&album_id=<?php echo $this->_var['filter']['album_id']; ?>">
                            <ul class="ga-images-ul">
                                <?php $_from = $this->_var['pic_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'pic_list_0_05929300_1590396118');if (count($_from)):
    foreach ($_from AS $this->_var['pic_list_0_05929300_1590396118']):
?>
                                <li><a href="javascript:;" onclick="addpic('<?php echo $this->_var['pic_list_0_05929300_1590396118']['pic_file']; ?>',this)"><img src="<?php echo $this->_var['pic_list_0_05929300_1590396118']['pic_file']; ?>"><span class="pixel"><?php echo $this->_var['pic_list_0_05929300_1590396118']['pic_spec']; ?></span></a></li>
                                <?php endforeach; else: ?>
                                <li class="notic"><?php echo $this->_var['lang']['no_image']; ?></li>
                                <?php endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            </ul>
