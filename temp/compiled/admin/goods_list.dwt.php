        	...
        	<div class="tabs_info">
            	<ul>
                    <li <?php if ($this->_var['menu_select']['current'] == '01_goods_list'): ?>class="curr"<?php endif; ?>>
                    	<a href="goods.php?act=list<?php echo $this->_var['seller_list']; ?>"><?php echo $this->_var['lang']['ordinary_goods']; ?> <?php if ($this->_var['menu_select']['current'] != '01_goods_list'): ?><em class="li_color" id="ordinary"></em><?php endif; ?></a>
                    </li>
                    <li <?php if ($this->_var['menu_select']['current'] == '50_virtual_card_list'): ?>class="curr"<?php endif; ?>>
                    	<a href="goods.php?act=list&extension_code=virtual_card<?php echo $this->_var['seller_list']; ?>"><?php echo $this->_var['lang']['virtual_goods']; ?> <?php if ($this->_var['menu_select']['current'] != '50_virtual_card_list'): ?><em class="li_color" id="virtual_card"></em><?php endif; ?></a>
                    </li>
                	...
                	<li <?php if ($this->_var['menu_select']['current'] == '01_review_status'): ?>class="curr"<?php endif; ?>>
                    	<a href="goods.php?act=review_status<?php echo $this->_var['seller_list']; ?>"><?php echo $this->_var['lang']['01_review_status']; ?> <?php if ($this->_var['menu_select']['current'] != '01_review_status'): ?><em class="li_color" id="review_status"></em><?php endif; ?></a>
                    </li>
                    <?php endif; ?>
					<li <?php if ($this->_var['menu_select']['current'] == '11_goods_trash'): ?>class="curr"<?php endif; ?>>
                    	<a href="goods.php?act=trash<?php echo $this->_var['seller_list']; ?>"><?php echo $this->_var['lang']['11_goods_trash']; ?> <?php if ($this->_var['menu_select']['current'] != '11_goods_trash'): ?><em class="li_color" id="is_delete"></em><?php endif; ?></a>
                    </li>
                    <li <?php if ($this->_var['menu_select']['current'] == '19_is_sale'): ?>class="curr"<?php endif; ?>>
                    	<a href="goods.php?act=is_sale<?php echo $this->_var['seller_list']; ?>"><?php echo $this->_var['lang']['shelves_goods']; ?> <?php if ($this->_var['menu_select']['current'] != '19_is_sale'): ?><em class="li_color" id="is_sale"></em><?php endif; ?></a>
                    </li>
                    
                    <li <?php if ($this->_var['menu_select']['current'] == '20_is_sale'): ?>class="curr"<?php endif; ?>>
                    	<a href="goods.php?act=on_sale<?php echo $this->_var['seller_list']; ?>"><?php echo $this->_var['lang']['off_the_shelf_goods']; ?> <?php if ($this->_var['menu_select']['current'] != '20_is_sale'): ?><em class="li_color" id="on_sale"></em><?php endif; ?></a>
                    </li>
                </ul>
            </div>
            <div class="flexilist">
...
?>
	...
	*/
	...
	function getGoodsNumber()
	{
		...
		var seller_list = '<?php echo $this->_var['seller_list']; ?>';
