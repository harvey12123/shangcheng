...
?>
        ...
        <?php if ($this->_var['nav']['type'] != "" && $this->_var['nav']['type'] != "menuinformation"): ?><li data-param="<?php echo $this->_var['nav']['type']; ?>"><a href="javascript:void(0);"><?php echo $this->_var['nav']['label']; ?></a></li><?php endif; ?>
        <?php endif; ?>
