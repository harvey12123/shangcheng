...
?>
                                            ...
                                            <td><div class="tDiv"><?php if ($this->_var['order']['pay_status'] == 2): ?><span>已付款</span><br><?php echo $this->_var['order']['pay_time']; ?><?php else: ?><span>未付款</span><?php endif; ?></div></td>
                                            <td class="handle">
                                                <div class="tDiv a2">
...
?>
                                                            ...
                                                            $.jqueryAjax("wholesale_order.php", "act=merge_order_list", function(data){
                                                            pb({
                                                            id:"merge_dialog",
                                                                    title:"合并订单",
                                                                    width:635,
                                                            ...
                                                            var store_search = $("#store_name_val").val();
                                                                    ...
                                                                    $.jqueryAjax("wholesale_order.php", "act=ajax_merge_order_list&store_search=" + store_search + "&merchant_id=" + merchant_id, function(data){
                                                                     ...
                                                                     */
                                                                            ...
                                                                            var fromOrderSn = $('#main_order_val').val();
                                                                                    ...
                                                                                    Ajax.call('wholesale_order.php?is_ajax=1&act=ajax_merge_order', 'from_order_sn=o' + fromOrderSn + '&to_order_sn=o' + toOrderSn, mergeResponse, 'POST', 'JSON');
                                                                            }
