...
<body class="iframe_body">
	<div class="warpper">
		<div class="title"><?php echo $this->_var['lang']['26_login']; ?> - <?php echo $this->_var['ur_here']; ?></div>
        <div class="content">	
...
?>
                                <?php if ($this->_var['val']['type'] != '' && $this->_var['val']['type'] != 'taobao' && $this->_var['val']['type'] != 'alipay'): ?>
                            	<tr>
                                	...
                                	<td colspan="15">
                                        <div class="tDiv">
                                            <div class="tfoot_btninfo">
                                                ...
                                                <input type="submit" value="<?php echo $this->_var['lang']['button_submit_alt']; ?>" name="remove" id="btnSubmit" ectype="btnSubmit" class="btn btn_disabled " disabled="">
	...
	<script type="text/javascript" language="JavaScript">
		...
		*/
		...
		function changeAction(){
			...
			if ($('#btnSubmit').attr("disabled") != 'disabled' && confirmSubmit(frm, false)){
				frm.submit();
			}
		}
	</script>
