...
?>
        ...
        <div class="lift lift-mode-<?php echo empty($this->_var['floor_nav_type']) ? 'one' : $this->_var['floor_nav_type']; ?> lift-hide" ectype="lift" data-type="<?php echo empty($this->_var['floor_nav_type']) ? 'one' : $this->_var['floor_nav_type']; ?>" style="z-index:100001">
            <div class="lift-list" ectype="liftList">
                ...
                <?php $_from = $this->_var['floor_data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'data_0_50985600_1590260262');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['data_0_50985600_1590260262']):
?>
                <div class="lift-item lift-floor-item" ectype="liftItem"><span><?php echo $this->_var['data_0_50985600_1590260262']['name']; ?></span><i class="lift-arrow"></i></div>
                ...
                <div class="lift-item" ectype="liftItem" data-target="#guessYouLike"><span><?php echo $this->_var['lang']['lift_guessYouLike']; ?></span><i class="lift-arrow"></i></div>
