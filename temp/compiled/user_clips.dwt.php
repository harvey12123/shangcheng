                    ...
                    <div class="user-items">
                        ...
                        <div class="item">
                            ...
                            <div class="value value-checkbox">
                                <div class="txt-lh"><a href="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/wlmoban_dsc2017/images/note.gif" style="margin-top:-3px;"/>&nbsp;&nbsp;<?php echo $this->_var['order_info']['order_sn']; ?></a></div>
                            </div>
                        </div>    
...
?>
										...
										<dl class="mod-select mod-select-small" ectype="smartdropdown">
											...
											<dd ectype="layer">
												...
												<?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_62141000_1590458448');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_62141000_1590458448']):
?>
												<div class="option" data-value="<?php echo $this->_var['province_0_62141000_1590458448']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_62141000_1590458448']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_62141000_1590458448']['region_name']; ?></div>
												<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
											</dd>
										</dl>
										<dl class="mod-select mod-select-small" ectype="smartdropdown">
