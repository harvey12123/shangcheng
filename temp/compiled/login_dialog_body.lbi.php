...
?>
	...
	<?php $_from = $this->_var['user_lang']['passport_js']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'lang_0_27496600_1590313199');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['lang_0_27496600_1590313199']):
?>
	var <?php echo $this->_var['k']; ?>="<?php echo $this->_var['lang_0_27496600_1590313199']; ?>";
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		/* *
		 * 会员登录
		*/ 
