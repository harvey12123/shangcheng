...
?>
                                ...
                                <div class="imitate_select w90">
                                    ...
                                    <ul>
                                        <?php $_from = $this->_var['select_date']['day']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'data_0_08907600_1590458433');if (count($_from)):
    foreach ($_from AS $this->_var['data_0_08907600_1590458433']):
?>
                                        <li><a href="javascript:void(0);" data-value="<?php echo $this->_var['data_0_08907600_1590458433']; ?>"><?php echo $this->_var['data_0_08907600_1590458433']; ?></a></li>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </ul>
                            ...
                            <div class="value">
                                <div class="imitate_select w200">
                                    ...
                                    <ul>
                                        ...
                                        <?php $_from = $this->_var['passwd_questions']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'data_0_09092700_1590458433');if (count($_from)):
    foreach ($_from AS $this->_var['data_0_09092700_1590458433']):
?>
                                        <li><a href="javascript:void(0);" data-value="<?php echo $this->_var['data_0_09092700_1590458433']; ?>"><?php echo $this->_var['data_0_09092700_1590458433']; ?></a></li>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </ul>
...
?>
                            ...
                            <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
                                ...
                                <dd ectype="layer">
                                    ...
                                    <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_14348500_1590458433');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_14348500_1590458433']):
?>
                                    <div class="option" data-value="<?php echo $this->_var['province_0_14348500_1590458433']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_14348500_1590458433']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_14348500_1590458433']['region_name']; ?></div>
                                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                </dd>
                            </dl>
                            <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
                            ...
                            <div class="lists" ectype="return_lists">
                                ...
                                <div class="return_div" ectype="return_div" style="display:none;">
                                    <div class="type_box1" name="type_box1" id="changeid_<?php echo $this->_var['goods_return']['rec_id']; ?>">
                                        ...
                                        <div class="type_con">
                                            <?php if (! $this->_var['order']['is_baitiao_order']): ?>
                                            <a onclick="buyNumber.minus(this, 1)" href="javascript:;" id="decrease" class="plus_minus"><i class="iconfont icon-reduce"></i></a>
                                            <?php endif; ?>
                                            <input type="text" class="return_num" defaultnumber="1" <?php if ($this->_var['order']['is_baitiao_order']): ?> value="<?php echo $this->_var['goods_return']['goods_number']; ?>"  readonly="readonly" <?php else: ?>value="1" <?php endif; ?>id="returnid_<?php echo $this->_var['goods_return']['rec_id']; ?>" name="only_return_number" onblur="check_return_num(this,<?php echo $this->_var['goods_return']['goods_number']; ?> ,<?php echo $this->_var['goods_return']['rec_id']; ?>, 2)" />
                                            <?php if (! $this->_var['order']['is_baitiao_order']): ?>
                                            <a onclick="buyNumber.plus(this, 1)" href="javascript:;" id="increase" class="plus_minus"><i class="iconfont icon-plus"></i></a>
                                             <div class="return_sm">(<?php echo $this->_var['lang']['return_one']; ?><span><?php echo $this->_var['goods_return']['goods_number']; ?></span><?php echo $this->_var['lang']['return_two']; ?><span id="retired_<?php echo $this->_var['goods_return']['rec_id']; ?>" name="retired">1</span><?php echo $this->_var['lang']['jian']; ?>)</div>
                                            <?php endif; ?>
...
?>
                                        ...
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
                                            ...
                                            <dd ectype="layer">
                                                <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                                <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_15543800_1590458433');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_15543800_1590458433']):
?>
                                                <div class="option" data-value="<?php echo $this->_var['province_0_15543800_1590458433']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_15543800_1590458433']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_15543800_1590458433']['region_name']; ?></div>
                                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                            </dd>
                                        </dl>
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
...
?>
								...
								<dl class="mod-select mod-select-small" ectype="smartdropdown">
									...
									<dd ectype="layer">
										<div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
										<?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_16095600_1590458433');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_16095600_1590458433']):
?>
										<div class="option" data-value="<?php echo $this->_var['province_0_16095600_1590458433']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_16095600_1590458433']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_16095600_1590458433']['region_name']; ?></div>
										<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
									</dd>
								</dl>
								<dl class="mod-select mod-select-small" ectype="smartdropdown">
...
?>
                            <tr>
                                ...
                                <td class="tc">
                                    ...
                                    <?php else: ?>
                                        <?php if ($this->_var['list']['is_refund']): ?>
                                            <?php echo $this->_var['lang']['refound']; ?>
                                        <?php else: ?>
            ...
            <div class="user-bonus-temp" ectype="tabSection">
                <div class="user-title">
                    <ul class="tabs" ectype="tabs">
                        ...
                        <li id="invalid_giftcard"><a href="javascript:void(0);"><?php echo $this->_var['lang']['overdue']; ?>(<?php echo $this->_var['bonus3']['record_count']; ?>)</a></li>
                    </ul>
                </div>
...
?>
                    ...
                    <div id="gift_card_list_4" style=" display:none">
                        <?php if ($this->_var['bonus3']['invalid_list']): ?>
                        <div class="items">
                            <?php $_from = $this->_var['bonus3']['invalid_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item');$this->_foreach['invalid_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['invalid_list']['total'] > 0):
    foreach ($_from AS $this->_var['item']):
        $this->_foreach['invalid_list']['iteration']++;
?>
                            <div class="item item-disabled<?php if ($this->_foreach['useup_list']['iteration'] % 3 == 0): ?> item-last<?php endif; ?>">
                                <div class="b-price"><?php echo $this->_var['item']['type_money']; ?></div>
                                <div class="b-i-bot">
                                ...
                                <i class="i-soon"><?php echo $this->_var['lang']['overdue']; ?></i>
                            </div>
                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        </div>
                        <?php else: ?>
...
?>
                                ...
                                <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
                                    ...
                                    <dd ectype="layer">
                                        <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                        <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_22476000_1590458433');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_22476000_1590458433']):
?>
                                        <div class="option" data-value="<?php echo $this->_var['province_0_22476000_1590458433']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_22476000_1590458433']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_22476000_1590458433']['region_name']; ?></div>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </dd>
                                </dl>
                                <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
...
?>
                                ...
                                <div class="list-div" id="detailCategoryTable">
                                    <table class="m-table mt20" >
                                        ...
                                        <tbody>
                                        <?php $_from = $this->_var['category_info']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'category_0_22588700_1590458433');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['category_0_22588700_1590458433']):
?>
                                            <tr>
                                                <td align="center">
                                                    <p>
                                                        <span class="index"><?php echo $this->_var['k']; ?></span>
                                                        <input type="hidden" value="<?php echo $this->_var['category_0_22588700_1590458433']['cat_id']; ?>" name="cat_id[]" class="cId">
                                                    </p>
                                                </td>
                                                <td align="center" >
                                                    <p>
                                                        <input type="hidden" value="<?php echo $this->_var['category_0_22588700_1590458433']['parent_name']; ?>" name="parent_name[]" class="cl1Name">
                                                        <?php echo $this->_var['category_0_22588700_1590458433']['parent_name']; ?>
                                                    </p>
                                                </td>
                                                <td align="center">
                                                    <p>
                                                        <input type="hidden" value="<?php echo $this->_var['category_0_22588700_1590458433']['cat_name']; ?>" name="cat_name[]" class="cl2Name">
                                                        <?php echo $this->_var['category_0_22588700_1590458433']['cat_name']; ?>
                                                    </p>
                                                </td>
                                                <td><div class="tDiv"><a class="btn_trash" href="javascript:void(0);" onClick="deleteChildCate(<?php echo $this->_var['category_0_22588700_1590458433']['ct_id']; ?>)"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['drop']; ?></a></div></td>
                                            </tr>
                                        <?php endforeach; else: ?>
...
?>
                                ...
                                <dl class="mod-select mod-select-small" ectype="smartdropdown">
                                    ...
                                    <dd ectype="layer">
                                        <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                        <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_23139300_1590458433');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_23139300_1590458433']):
?>
                                        <div class="option" data-value="<?php echo $this->_var['province_0_23139300_1590458433']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_23139300_1590458433']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_23139300_1590458433']['region_name']; ?></div>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </dd>
                                </dl>
                                <dl class="mod-select mod-select-small" ectype="smartdropdown">
...
?>
                                        ...
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
                                            ...
                                            <dd ectype="layer">
                                                <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                                <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_24713300_1590458433');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_24713300_1590458433']):
?>
                                                <div class="option" data-value="<?php echo $this->_var['province_0_24713300_1590458433']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_24713300_1590458433']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_24713300_1590458433']['region_name']; ?></div>
                                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                            </dd>
                                        </dl>
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
...
<?php echo $this->smarty_insert_scripts(array('files'=>'jquery.SuperSlide.2.1.1.js,jquery.yomi.js,common.js,./sms/sms.js,jquery.validation.min.js,jquery.nyroModal.js,perfect-scrollbar/perfect-scrollbar.min.js,calendar.php,plupload.full.min.js,lib_wlmobanFunc.js,user.js,jquery.picTip.js')); ?>
<?php if ($this->_var['action'] == 'profile'): ?>
