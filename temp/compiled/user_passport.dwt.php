    ...
    <div class="loginRegister-header">
        <div class="w w1200">
            ...
            <?php if ($this->_var['shop_reg_closed'] != 1): ?>
                <span><?php echo $this->_var['lang']['not_account_number']; ?><a href="user.php?act=register" class="jump"><?php echo $this->_var['lang']['Free_registration']; ?></a></span>
            <?php endif; ?>
            </div>
        </div>
    </div>
...
<div class="register">
    <div class="loginRegister-header">
        <div class="w w1200">
            ...
            <div class="header-href">
                <span><?php echo $this->_var['lang']['label_registered']; ?><a href="user.php" class="jump"><?php echo $this->_var['lang']['login_here']; ?></a></span>
            </div>
        </div>
    </div>
    <div class="container">
...
?><?php if ($this->_var['field']['id'] == 6): ?> gptabThree<?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>" ectype="gpTab">
                                <ul>
                                    ...
                                    <li class="curr"><i class="iconfont icon-mobile-phone"></i><span><?php echo $this->_var['lang']['mobile_retrieve']; ?></span></li>
                                    <li><i class="iconfont icon-email"></i><span><?php echo $this->_var['lang']['email_retrieve']; ?></span></li>
                                    <?php else: ?>
                                    <li class="curr"><i class="iconfont icon-email"></i><span><?php echo $this->_var['lang']['email_retrieve']; ?></span></li>
                                    <?php endif; ?>
                                    <?php $_from = $this->_var['extend_info_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'field');if (count($_from)):
    foreach ($_from AS $this->_var['field']):
?><?php if ($this->_var['field']['id'] == 6): ?><li ectype="gptabLast"><i class="iconfont icon-icon02"></i><span><?php echo $this->_var['lang']['Regist_problem']; ?></span></li><?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        ...
                        <div class="gp-content" ectype="gpContent">
                                ...
                                <form action="user.php" method="post" name="getPhonePassword" ectype="form">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="item-info">
                                        	...
                                        	<span class="fr lh30 red"><?php echo $this->_var['lang']['captcha_notic']; ?></span>
                                        </div>
                                        <div class="input-tip"></div>
                                    </div>
                                    <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <div class="gp-warp formEmail" <?php if ($this->_var['enabled_sms_signin'] == 0): ?>style="display:block;"<?php endif; ?>>
                                <form action="user.php" method="post" name="getEmailPassword" ectype="form">
                                    ...
                                    <div class="item">
                                        <div class="item-label"><?php echo $this->_var['lang']['email_account']; ?></div>
...
?>
                                ...
                                <div class="item item2 item-button">
                                    ...
                                    <input type="submit" name="submit" value="<?php echo $this->_var['lang']['submit']; ?>" class="btn sc-redBg-btn" ectype="submitBtn">
                                </div>
                                </form>
                            </div>
                        </div>
