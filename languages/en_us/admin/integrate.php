...
$_LANG['need_not_setup'] = 'You needn\\`t set wehn you use wlshop systerm';
$_LANG['neednot_sync'] = 'You needn\'t synchronous operation, beacuse the wlshop member system is in use now.';
$_LANG['different_domain'] = 'The integration object and wlshop of[with] your setup is not under same area.<Br/>you member\'s data that can share that system, but can\'t carry out to register in the meantime.';
...
$_LANG['ucenter_notice_key'] = 'Communication key for UCenter and wlshop information between the transmission of encrypted, can contain any letters and numbers, please UCenter with identical settings wlshop communication key to ensure that the two systems, normal communication can';
...
$_LANG['uc_notice_ip'] = 'Some effort to connect the process of problem, please fill out the server IP address, if you have UC and wlshop mounted on the same server, we recommend that you try to fill in 127.0.0.1';
