...
$_LANG['export_wlshop'] = 'Export to wlshop data format';
$_LANG['wlshop']['goods_name'] = '商品名称';
$_LANG['wlshop']['goods_sn'] = '商品货号';
$_LANG['wlshop']['brand_name'] = '商品品牌';
$_LANG['wlshop']['market_price'] = '市场售价';
$_LANG['wlshop']['shop_price'] = '本店售价';
$_LANG['wlshop']['integral'] = '积分购买额度';
$_LANG['wlshop']['original_img'] = '商品原始图';
$_LANG['wlshop']['goods_img'] = '商品图片';
$_LANG['wlshop']['goods_thumb'] = '商品缩略图';
$_LANG['wlshop']['keywords'] = '商品关键词';
$_LANG['wlshop']['goods_brief'] = '简单描述';
$_LANG['wlshop']['goods_desc'] = '详细描述';
$_LANG['wlshop']['goods_weight'] = '商品重量（kg）';
$_LANG['wlshop']['goods_number'] = '库存数量';
$_LANG['wlshop']['warn_number'] = '库存警告数量';
$_LANG['wlshop']['is_best'] = '是否精品';
$_LANG['wlshop']['is_new'] = '是否新品';
$_LANG['wlshop']['is_hot'] = '是否热销';
$_LANG['wlshop']['is_on_sale'] = '是否上架';
$_LANG['wlshop']['is_alone_sale'] = '能否作为普通商品销售';
$_LANG['wlshop']['is_real'] = '是否实体商品';
