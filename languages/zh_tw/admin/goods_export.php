...
$_LANG['export_wlshop'] = '導出到wlshop數據格式';
$_LANG['wlshop']['goods_name'] = '商品名稱';
$_LANG['wlshop']['goods_sn'] = '商品貨號';
$_LANG['wlshop']['brand_name'] = '商品品牌';
$_LANG['wlshop']['market_price'] = '市場售價';
$_LANG['wlshop']['shop_price'] = '本店售價';
$_LANG['wlshop']['integral'] = '積分購買額度';
$_LANG['wlshop']['original_img'] = '商品原始圖';
$_LANG['wlshop']['goods_img'] = '商品圖片';
$_LANG['wlshop']['goods_thumb'] = '商品縮略圖';
$_LANG['wlshop']['keywords'] = '商品關鍵詞';
$_LANG['wlshop']['goods_brief'] = '簡單描述';
$_LANG['wlshop']['goods_desc'] = '詳細描述';
$_LANG['wlshop']['goods_weight'] = '商品重量（kg）';
$_LANG['wlshop']['goods_number'] = '庫存數量';
$_LANG['wlshop']['warn_number'] = '庫存警告數量';
$_LANG['wlshop']['is_best'] = '是否精品';
$_LANG['wlshop']['is_new'] = '是否新品';
$_LANG['wlshop']['is_hot'] = '是否熱銷';
$_LANG['wlshop']['is_on_sale'] = '是否上架';
$_LANG['wlshop']['is_alone_sale'] = '能否作為普通商品銷售';
$_LANG['wlshop']['is_real'] = '是否實體商品';
