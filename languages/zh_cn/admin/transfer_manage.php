...
$_LANG['nav_list'] = '商品列表|goods.php?act=list,订单列表|order.php?act=list,用户评论|comment_manage.php?act=list,会员列表|users.php?act=list,平台设置|shop_config.php?act=list_edit';
$_LANG['export_format'] = '数据格式';
$_LANG['export_wlshop'] = 'wlshop支持数据格式';
...
$_LANG['database_name_notic'] = '示例：wlmoban_dsc';
