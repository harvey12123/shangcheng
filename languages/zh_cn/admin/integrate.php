...
$_LANG['different_domain'] = '您设置的整合对象和 wlshop 不在同一域下。<br />您将只能共享该系统的会员数据，但无法实现同时登录。';
...
$_LANG['ucenter_notice_key'] = '通信密钥用于在 UCenter 和 wlshop 之间传输信息的加密，可包含任何字母及数字，请在 UCenter 与 wlshop 设置完全相同的通讯密钥，以确保两套系统能够正常通信';
...
$_LANG['uc_notice_ip'] = '连接的过程中出了点问题，请您填写服务器 IP 地址，如果您的 UC 与 wlshop 装在同一服务器上，我们建议您尝试填写 127.0.0.1';
