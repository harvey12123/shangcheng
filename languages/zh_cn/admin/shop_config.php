...
$_LANG['cfg_desc']['server_model'] = '如果平台没有采用负载均衡方式运行(比如阿里云的负载均衡)，请设置单台服务器方式';
...
$_LANG['cfg_name']['sms_wlmoban_user'] = '短信接口用户名';
$_LANG['cfg_name']['sms_wlmoban_password'] = '短信接口密码';
...
// $_LANG['cfg_range']['sms_type'][3] = '中国联通短信 <font class=\'red\'>[推荐]</font>';
...
$_LANG['cfg_name']['dsc_appkey'] = '中国联通(appKey)';
$_LANG['cfg_name']['dsc_appsecret'] = '中国联通(appSecret)';
...
$_LANG['cfg_name']['sms_wlmoban_user'] = '互亿在线短信接口用户名';
$_LANG['cfg_name']['sms_wlmoban_password'] = '互亿在线短信接口密码';
...
$_LANG['cfg_name']['wenlv_qrcode'] = '底部二维码右边';
$_LANG['cfg_name']['wljia_qrcode'] = '底部二维码左边';
...
$_LANG['cfg_name']['shop_name'] = '平台名称';
$_LANG['cfg_name']['shop_title'] = '平台标题';
$_LANG['cfg_name']['shop_website'] = '平台网址';
$_LANG['cfg_name']['shop_desc'] = '平台描述';
$_LANG['cfg_name']['shop_keywords'] = '平台关键字';
...
$_LANG['cfg_name']['shop_notice'] = '商城公告';
...
$_LANG['cfg_name']['close_comment'] = '关闭平台的原因';
...
$_LANG['cfg_name']['shop_logo'] = '平台Logo';
...
$_LANG['cfg_desc']['shop_title'] = '平台的标题，将显示在浏览器的标题栏Title';
$_LANG['cfg_desc']['shop_desc'] = '平台描述内容，将显示在浏览器的Description';
$_LANG['cfg_desc']['shop_keywords'] = '平台的关键字，将显示在浏览器的Keywords';
$_LANG['cfg_desc']['shop_address'] = '平台详细地址，不显示在前台';
...
$_LANG['cfg_desc']['service_email'] = '平台客服邮箱地址，接收发送的信息';
$_LANG['cfg_desc']['service_phone'] = '平台客服电话，联系平台电话，例：入驻页面导航显示的电话';
...
$_LANG['cfg_desc']['shop_notice'] = '以上内容将显示在首页商城公告中,注意控制公告内容长度不要超过公告显示区域大小。';
...
$_LANG['cfg_desc']['shop_closed'] = '平台需升级或者其他原因临时关闭网站';
$_LANG['cfg_desc']['close_comment'] = '平台临时关闭网站说明原因';
$_LANG['cfg_desc']['shop_reg_closed'] = '平台是否关闭前台会员注册';
$_LANG['cfg_desc']['lang'] = '平台系统使用的语言，zh_cn是简体中文，zh_tw是繁体中文，en_us是英文';
...
$_LANG['js_languages']['seller_info_notic'] = '平台名称不能为空';
$_LANG['btnSubmit_notice'] = '平台设置 -> 购物流程 -> 发票税率重复：';
$_LANG['type_already_exists'] = '类型已存在';
$_LANG['type_taxrate_not_notic'] = '类型和税率不能为空';
$_LANG['taxrate_number'] = '税率必须为数字';
$_LANG['tutorials_bonus_list_one'] = "<a href=\"http://www.jabrielcloud.com/article-6273.html\" target=\"_blank\">平台设置---平台基本信息设置</a>\r\n                            <a href=\"http://www.jabrielcloud.com/article-6274.html\" target=\"_blank\">平台设置---客服设置</a>\r\n                            <a href=\"http://www.jabrielcloud.com/article-6268.html\" target=\"_blank\">平台设置---市场价格比例及积分比例设置</a>\r\n                            <a href=\"http://www.jabrielcloud.com/article-6271.html\" target=\"_blank\">平台设置---设置区分地区商品</a>\r\n                            <a href=\"http://www.jabrielcloud.com/article-6266.html\" target=\"_blank\">平台设置---短信设置</a>\r\n                            <a href=\"http://www.jabrielcloud.com/article-6267.html\" target=\"_blank\">平台设置---WAP设置</a>\r\n                            <a href=\"http://www.jabrielcloud.com/article-6265.html\" target=\"_blank\">平台设置---商品属性价格模式设置</a>";
$_LANG['tutorials_bonus_list_two'] = '平台邮件服务器设置';
$_LANG['operation_prompt_content']['shop_config'][0] = '平台相关信息设置，请谨慎填写信息。';
