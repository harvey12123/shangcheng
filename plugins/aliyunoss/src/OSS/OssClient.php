...
class OssClient
{
	...
	const OSS_HEADERS = Core\OssUtil::OSS_HEADERS;
	...
	const OSS_MAX_OBJECT_GROUP_VALUE = Core\OssUtil::OSS_MAX_OBJECT_GROUP_VALUE;
	const OSS_MAX_PART_SIZE = Core\OssUtil::OSS_MAX_PART_SIZE;
	const OSS_MID_PART_SIZE = Core\OssUtil::OSS_MID_PART_SIZE;
	const OSS_MIN_PART_SIZE = Core\OssUtil::OSS_MIN_PART_SIZE;
	...
	const OSS_CONTENT = Core\OssUtil::OSS_CONTENT;
	const OSS_BODY = 'body';
	const OSS_LENGTH = Core\OssUtil::OSS_LENGTH;
	const OSS_HOST = 'Host';
	const OSS_DATE = 'Date';
