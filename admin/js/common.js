        ...
        if(total != 0){
			...
			//商家提醒 start
				...
				if(wait_balance >= 0  && wait_balance<100){
					$("*[ectype='sellerMsg']").append('<p><a href="javascript:void(0);" data-url="merchants_commission.php?act=commission_bill&bill_apply=1" data-param="menushopping|05_seller_account_log" target="workspace" class="message">待审核商家结算</a> <span class="tiptool">（<em id="seller_account">'+wait_balance+'</em>）</span></p>')
				}else if(wait_balance > 99){
					$("*[ectype='sellerMsg']").append('<p><a href="javascript:void(0);" data-url="merchants_commission.php?act=commission_bill&bill_apply=1" data-param="menushopping|05_seller_account_log" target="workspace" class="message">待审核商家结算</a><span class="tiptool">（<em id="seller_account">99+</em>）</span></p>')
				}
				//待审核商家结算 end
			...
			if(advance_date >= 0  && advance_date<100){
                $("*[ectype='advMsg']").html("").append('<p><a href="javascript:void(0);" data-url="ads.php?act=list&advance_date=1" data-param="menuplatform|ad_list" target="workspace" class="message">广告即将到期</a> <span class="tiptool">（<em id="advance_date">'+advance_date+'</em>）</span></p>')
            }else if(advance_date > 99){
                $("*[ectype='advMsg']").html("").append('<p><a href="javascript:void(0);" data-url="ads.php?act=list&advance_date=1" data-param="menushopping|ad_list" target="workspace" class="message">广告即将到期</a><span class="tiptool">（<em id="advance_date">99+</em>）</span></p>')
            }
			//广告位提醒 end
