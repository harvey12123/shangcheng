...
$modules['20_wenlv']['05_touch_dashboard'] = '../mobile/index.php?r=admin/editor';
...
$modules['20_wljia_app']['02_wljia_app_shortcut'] = 'wljia_shortcut.php?act=list';
$modules['20_wljia_app']['03_wljia_app_shortcut_ipad'] = 'wljia_shortcut_ipad.php?act=list';
$modules['20_wljia_app']['04_wljia_app_cycleimage'] = 'wljia_cycleimage.php?act=list';
$modules['20_wljia_app']['05_wljia_app_cycleimage_ipad'] = 'wljia_cycleimage_ipad.php?act=list';
$modules['20_wljia_app']['06_wljia_app_discover'] = 'wljia_discover.php?act=list';
$modules['20_wljia_app']['08_wljia_app_device'] = 'wljia_device.php?act=list';
$modules['20_wljia_app']['12_wljia_app_config'] = 'wljia_config.php?act=list';
$modules['20_wljia_app']['14_wljia_app_manage'] = 'wljia_mobile_manage.php?act=list';
$modules['20_wljia_app']['16_wljia_app_toutiao'] = 'wljia_mobile_toutiao.php?act=list';
$modules['20_wljia_app']['18_wljia_app_activity'] = 'wljia_mobile_activity.php?act=list';
$modules['24_wljia_sms']['02_wljia_sms_record'] = 'wljia_sms_record.php?act=list';
$modules['24_wljia_sms']['04_wljia_sms_template'] = 'wljia_sms.php?act=list';
$modules['26_wljia_feedback']['08_wljia_feedback_mobile'] = 'wljia_feedback.php?act=list';
$modules['28_wljia_marketing']['02_wljia_marketing_adviser'] = 'wljia_adviser.php?act=list';
$modules['30_wljia_push']['02_wljia_push_record'] = 'wljia_push_record.php?act=list';
$modules['30_wljia_push']['04_wljia_push_event'] = 'wljia_push_event.php?act=list';
$modules['30_wljia_push']['06_wljia_push_template'] = 'wljia_push_template.php?act=list';
$modules['30_wljia_push']['08_wljia_push_config'] = 'wljia_push_config.php?act=list';
$modules['20_wenlv']['01_oauth_admin'] = '../mobile/index.php?r=oauth/admin';
$modules['20_wenlv']['02_touch_nav_admin'] = 'touch_navigator.php?act=list';
$modules['20_wenlv']['03_touch_ads'] = 'touch_ads.php?act=list';
$modules['20_wenlv']['04_touch_ad_position'] = 'touch_ad_position.php?act=list';
...
$menu_top['wenlv'] = '20_wenlv,22_wechat,23_drp,24_wxapp';
