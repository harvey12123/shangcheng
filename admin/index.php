...
');
	...
	if (strpos($http, 'https://') === false) {
		$Loaction = 'http://www.jabrielcloud.com/cloud/index.html';
	}
	else {
		$Loaction = 'http://www.jabrielcloud.com/cloud/index.html';
	}
...
');
	...
	if (strpos($http, 'https://') === false) {
		$Loaction = 'http://www.jabrielcloud.com/cloud/platform_rec.html';
	}
	else {
		$Loaction = 'http://www.jabrielcloud.com/cloud/platform_rec.html';
	}
...
');
	...
	if (strpos($http, 'https://') === false) {
		$Loaction = 'http://www.jabrielcloud.com/cloud/best_rec.html';
	}
	else {
		$Loaction = 'http://www.jabrielcloud.com/cloud/best_rec.html';
	}
