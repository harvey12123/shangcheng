...
function instfooter()
{
	echo '</div>' . '<div class="footer"><p>&copy; 2015-2020 <a href="http://demo.jabrielcloud.com" target="_blank">中国联通</a>。保留所有权利。</p></div>' . '</div>' . '</div></body></html>';
}
...
<legend>注意事项</legend>
<ul class="list">
<li>本转换程序只能针文旅新零售平台1.0或者以上版本程序的转换</li>
