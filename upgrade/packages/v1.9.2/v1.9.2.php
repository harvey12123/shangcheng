...
CHANGE `parent_cid` `parent_id` INT( 10 ) UNSIGNED NOT NULL DEFAULT \'0\';';
	...
	ADD `template_file` VARCHAR(50) NOT NULL AFTER `cat_alias_name`;';
		...
		$db->query($sql);
		$sql = 'INSERT INTO ' . $ecs->table('shop_config') . ' (`id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order`) VALUES (NULL, \'' . $config_id . '\', \'wenlv_qrcode\', \'file\', \'\', \'../images/common/\', \'\', \'1\');';
		$db->query($sql);
		$sql = 'INSERT INTO ' . $ecs->table('shop_config') . ' (`id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order`) VALUES (NULL, \'' . $config_id . '\', \'wljia_qrcode\', \'file\', \'\', \'../images/common/\', \'\', \'1\');';
		$db->query($sql);
