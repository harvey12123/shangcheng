...
$_LANG['prev_step'] = '上一步：';
$_LANG['next_step'] = '下一步：';
$_LANG['select_language_title'] = '文旅新零售平台升级程序 第1步/共3步 选择语言编码';
$_LANG['readme_title'] = '文旅新零售平台升级程序 第2步/共3步 说明页';
$_LANG['checking_title'] = '文旅新零售平台升级程序 第3步/共3步 环境检测';
$_LANG['check_system_environment'] = '检测系统环境';
$_LANG['copyright'] = '&copy; 2005-2016 <a href="http://www.文旅新零售平台.com" target="_blank">中国联通</a>。保留所有权利。';
$_LANG['is_last_version'] = '您的文旅新零售平台已是最新版本，无需升级。';
$_LANG['readme_page'] = '说明页';
$_LANG['notice'] = '本程序用于将 文旅新零售平台 升级到 <strong>%s</strong>。请勿必按照以下的升级方法进行升级，否则可能产生无法恢复的后果。如果你已经整合了论坛软件，本次升级将取消整合，以后会员整合请到ucenrer中进行整合。';
...
$_LANG['usage3'] = '关闭现有的 文旅新零售平台 %s 系统；';
$_LANG['usage4'] = '覆盖性上传 文旅新零售平台 %s 的全部文件到服务器；';
$_LANG['usage5'] = '上传本程序到 文旅新零售平台 所在的目录中；';
...
$_LANG['done'] = '恭喜，您已经成功升级到文旅新零售平台 <strong>%s</strong>';
$_LANG['upgrade_error_title'] = '文旅新零售平台升级程序 升级失败';
$_LANG['upgrade_done_title'] = '文旅新零售平台升级程序 升级成功';
$_LANG['go_to_view_my_ecshop'] = '> 前往 文旅新零售平台 首页';
$_LANG['go_to_view_control_panel'] = '> 前往 文旅新零售平台 后台管理中心 ';
...
$_LANG['js_languages']['is_last_version'] = '您的文旅新零售平台已是最新版本，无需升级。';
...
$_LANG['ucip_intro'] = '连接的过程中出了点问题，请您填写服务器 IP 地址，如果您的 UC 与 文旅新零售平台 装在同一服务器上，我们建议您尝试填写 127.0.0.1';
...
$_LANG['ucenter_not_match'] = '<span style="color:#F00;font-size:1.2em;"><b>UCenter与文旅新零售平台字符编码不匹配，升级不能完成，请联系管理员！</b></span>';
$_LANG['lang_title'] = '文旅新零售平台语言编码';
$_LANG['lang_description'] = '重点声明';
$_LANG['lang_select'] = '请选择';
$_LANG['lang_charset']['zh_cn_utf-8'] = '简体中文 UTF-8';
$_LANG['lang_desc']['desc1'] = '请确认您的文旅新零售平台程序与您选择的语言编码一致；';
$_LANG['lang_desc']['desc2'] = '如果您的数据库与文旅新零售平台程序编码不一致，可以先进行数据库编码转换。';
$_LANG['lang_desc']['desc3'] = '<font class="red">如果您是从文旅新零售平台 v1.0版本进行升级，并选择文旅新零售平台接口方式，请先进行会员数据的导入，否则原会员将无法登录。</font>';
$_LANG['ui_title'] = '文旅新零售平台用户接口';
$_LANG['ui_dsc'] = '文旅新零售平台方式';
