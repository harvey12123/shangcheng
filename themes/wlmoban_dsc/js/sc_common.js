$(function(){
	...
	$(document).ready(function(e) {
		...
		var div = $("<div class='support'></div>")
			.append("<p><a href='http://demo.zz.jabrielcloud.com//' target='_blank' style='color:#666;'>Powered by <span style='color:#ec5051'>文旅新零售平台1.0</span></a></p>");
...
$(function(){
	...
	$('#parent-cata-nav .item').unbind('mouseenter').bind('mouseenter',function(){
		...
		if(eveval != 1){
			...
			/*加载中by wu*/
			$('#brands_' + cat_id).html('<img src="themes/wlmoban_dsc/images/loadGoods.gif" width="200" height="200" class="lazy" style="margin:0 100px">');
			$.ajax({
			   type: "GET",
			   url: "get_ajax_content.php",
