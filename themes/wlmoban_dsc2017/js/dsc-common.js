...
$(function(){
	...
	$("*[ectype='cateItem']").on('mouseenter',function(){
		...
		if(eveval != 1){
			T.data('eveval', '1');
			/*加载中by wu*/
			layer.find("*[ectype='cateLayerCon_" + cat_id + "']").html('<img src="themes/wlmoban_dsc2017/images/load/loadGoods.gif" width="200" height="200" class="lazy">');
			$.ajax({
			   type: "GET",
			   url: "ajax_dialog.php",
	...
	$("*[ectype='items'] *[ectype='item']").on('mouseenter',function(){
		...
		if(eveval != 1){
			T.data('eveval', '1');
			/*加载中by wu*/
			layer.find("*[ectype='subitems_" + cat_id + "']").html('<img src="themes/wlmoban_dsc2017/images/load/loadGoods.gif" width="200" height="200" class="lazy">');
			$.ajax({
			   type: "GET",
