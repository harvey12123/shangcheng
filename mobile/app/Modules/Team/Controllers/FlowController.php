...
class FlowController extends FrontendController
{
    ...
    public function actionIndex()
    {
        ...
        if ((!isset($use_bonus) || $use_bonus == '1') && ($flow_type != CART_GROUP_BUY_GOODS && $flow_type != CART_EXCHANGE_GOODS && $flow_type != CART_TEAM_GOODS)) {
        ...
        if ((!isset($GLOBALS['_CFG']['use_coupons']) || $GLOBALS['_CFG']['use_coupons'] == '1') && ($flow_type != CART_GROUP_BUY_GOODS && $flow_type != CART_EXCHANGE_GOODS) && $flow_type != CART_PRESALE_GOODS && $flow_type != CART_EXCHANGE_GOODS && $flow_type != CART_AUCTION_GOODS) {
