...
class CartCombo extends \Illuminate\Database\Eloquent\Model
{
	...
	protected $fillable = array('user_id', 'session_id', 'goods_id', 'goods_sn', 'product_id', 'group_id', 'goods_name', 'market_price', 'goods_price', 'goods_number', 'goods_attr', 'img_flie', 'is_real', 'extension_code', 'parent_id', 'rec_type', 'is_gift', 'is_shipping', 'can_handsel', 'goods_attr_id', 'ru_id', 'warehouse_id', 'area_id', 'area_city', 'model_attr', 'add_time', 'commission_rate');
