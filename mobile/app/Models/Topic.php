...
class Topic extends \Illuminate\Database\Eloquent\Model
{
	...
	protected $fillable = array('user_id', 'title', 'intro', 'start_time', 'end_time', 'data', 'template', 'css', 'topic_img', 'title_pic', 'base_style', 'htmls', 'keywords', 'description', 'review_status', 'review_content');
