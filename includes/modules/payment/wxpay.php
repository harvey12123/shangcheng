 ...
 * 功能描述：微信支付插件
 * ----------------------------------------------------------------------------
 * Licensed ( http://www.jabrielcloud.com/docs/license.txt )
 * ----------------------------------------------------------------------------
 */
...
class wxpay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $this->setParameter("notify_url", str_replace('seller/','',$GLOBALS['ecs']->url()).'wxpay_native_callback.php');//通知地址
