...
$_LANG['welcome_title'] = '欢迎您选用文旅新零售平台2.7.3.4网上商店管理系统！';
...
$_LANG['checking_title'] = '文旅新零售平台2.7.3.4安装程序 第2步/共3步 环境检测';
...
$_LANG['setup'] = '填写完毕';
$_LANG['setting_title'] = '文旅新零售平台2.7.3.4安装程序 第3步/共3步 配置系统';
...
$_LANG['admin_user'][] = '平台设置|shop_config.php?act=list_edit';
...
$_LANG['has_locked_installer'] = '<a style="text-decoration:none; font-size:14px;">安装程序已经被锁定。</a><br /><a style="text-decoration:none; font-size:14px;">如果您确定要重新安装 <font style="color:#ec5150;">文旅新零售平台2.7.3.4</font>，请删除data目录下的 <font style="color:#ec5150;">install.lock.php</font>。</a>';
...
$_LANG['install_done_title'] = '文旅新零售平台2.7.3.4 安装程序 安装成功';
$_LANG['install_error_title'] = '文旅新零售平台2.7.3.4 安装程序 安装失败';
$_LANG['done'] = '基于安全的考虑，请在安装完成后删除 <em>install</em> 目录。';
$_LANG['go_to_view_my_sc'] = '前往 文旅新零售平台2.7.3.4 首页';
$_LANG['go_to_view_control_panel'] = '前往 文旅新零售平台2.7.3.4 后台管理中心';
