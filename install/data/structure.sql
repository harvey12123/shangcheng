...
Source Database       : dscjm2732

Target Server Type    : MYSQL
Target Server Version : 50553
File Encoding         : 65001

Date: 2019-01-26 07:23:00
*/
...
-- ----------------------------
-- Table structure for dsc_intelligent_weight
-- ----------------------------
DROP TABLE IF EXISTS `dsc_intelligent_weight`;
CREATE TABLE `dsc_intelligent_weight` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `goods_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '商品ID',
...
-- ----------------------------
-- Table structure for dsc_kdniao_customer_account
-- ----------------------------
...
-- ----------------------------
-- Table structure for dsc_kdniao_eorder_config
-- ----------------------------
...
CREATE TABLE `dsc_merchants_steps_fields` (
  ...
  `shop_buy_wlmoban_store` varchar(180) NOT NULL COMMENT '是否会选择文旅仓储',
...
-- ----------------------------
-- Table structure for dsc_merchants_steps_img
-- ----------------------------
DROP TABLE IF EXISTS `dsc_merchants_steps_img`;
CREATE TABLE `dsc_merchants_steps_img` (
...
-- ----------------------------
-- Table structure for dsc_order_cloud
-- ----------------------------
DROP TABLE IF EXISTS `dsc_order_cloud`;
CREATE TABLE `dsc_order_cloud` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for dsc_order_delayed
-- ----------------------------
DROP TABLE IF EXISTS `dsc_order_delayed`;
CREATE TABLE `dsc_order_delayed` (
...
CREATE TABLE `dsc_order_goods` (
  ...
  `is_distribution` int(1) DEFAULT NULL COMMENT '商品是否参与分销',
  `commission_rate` varchar(10) NOT NULL DEFAULT '0',
...
CREATE TABLE `dsc_order_info` (
  ...
  `drp_is_separate` tinyint(1) NOT NULL COMMENT '订单分销状态',
  `team_id` int(10) NOT NULL COMMENT '开团记录id',
...
CREATE TABLE `dsc_qrpay_log` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `pay_order_sn` (`pay_order_sn`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `dsc_seller_shopinfo` (
  ...
  `business_practice` tinyint(4) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ru_id` (`ru_id`),
  KEY `shipping_id` (`shipping_id`)
) ENGINE=MyISAM AUTO_INCREMENT=17 DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for dsc_seo
-- ----------------------------
DROP TABLE IF EXISTS `dsc_seo`;
CREATE TABLE `dsc_seo` (
...
-- ----------------------------
-- Table structure for dsc_solve_dealconcurrent
-- ----------------------------
DROP TABLE IF EXISTS `dsc_solve_dealconcurrent`;
CREATE TABLE `dsc_solve_dealconcurrent` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Table structure for dsc_store_back_order
-- ----------------------------
DROP TABLE IF EXISTS `dsc_store_back_order`;
CREATE TABLE `dsc_store_back_order` (
...
CREATE TABLE `dsc_team_goods` (
  ...
  `team_price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '拼团商品价格',
  `team_num` int(10) DEFAULT NULL COMMENT '几人团',
  `validity_time` int(10) DEFAULT NULL COMMENT '开团有效期(小时)',
  `limit_num` int(10) DEFAULT NULL COMMENT '已参团人数(添加虚拟数量)',
  `astrict_num` int(10) DEFAULT NULL COMMENT '限购数量',
  ...
  `sort_order` int(10) NOT NULL DEFAULT '0' COMMENT '排序',
  `team_desc` varchar(255) NOT NULL COMMENT '拼团介绍',
  `isnot_aduit_reason` varchar(255) NOT NULL COMMENT '审核未通过说明',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
...
CREATE TABLE `dsc_team_log` (
  ...
  `goods_id` mediumint(8) NOT NULL COMMENT '拼团商品id',
  `t_id` mediumint(8) NOT NULL COMMENT '拼团活动id',
  `start_time` int(10) DEFAULT NULL COMMENT '开团时间',
...
CREATE TABLE `dsc_users` (
  ...
  `drp_parent_id` int(11) NOT NULL COMMENT '分销商父级id',
...
CREATE TABLE `dsc_wechat_user` (
  ...
  `ect_uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'wlshop会员id',
  ...
  `drp_parent_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`uid`),
