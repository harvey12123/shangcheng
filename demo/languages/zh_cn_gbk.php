...
$_LANG['copyright'] = '&copy; 2015-2020 <a href="http://demo.jabrielcloud.com" target="_blank">中国联通</a>。保留所有权利。';
$_LANG['is_last_version'] = '您的文旅新零售平台已是最新版本，无需升级。';
$_LANG['readme_page'] = '说明页';
$_LANG['notice'] = '本程序将用于安装文旅新零售平台的测试数据，请务必确认以下问题。';
...
$_LANG['upgrade_error_title'] = '文旅新零售平台测试数据安装程序 测试数据安装失败';
$_LANG['upgrade_done_title'] = '文旅新零售平台测试数据安装程序 测试数据安装成功';
...
$_LANG['ui_title'] = '请选择文旅新零售平台使用的用户接口插件';
$_LANG['ui_ecshop'] = '文旅新零售平台方式';
